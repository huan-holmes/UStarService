...
if("TRUE" STREQUAL "TRUE")
  set(base_local_planner_SOURCE_PREFIX /home/boocax/UstarService/src/planning/base_local_planner)
  set(base_local_planner_DEVEL_PREFIX /home/boocax/UstarService/devel)
  ...
  set(base_local_planner_INSTALL_PREFIX /home/boocax/UstarService/install)
...
if(NOT "/home/boocax/UstarService/devel/include;/home/boocax/UstarService/src/planning/base_local_planner/include " STREQUAL " ")
  set(base_local_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/boocax/UstarService/devel/include;/home/boocax/UstarService/src/planning/base_local_planner/include")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/base_local_planner " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Huan Li <1124782663@qq.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'base_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/boocax/UstarService/src/planning/base_local_planner/${idir}'.  ${_report}")
    endif()
...
set(depends "angles;costmap;dynamic_reconfigure;geometry_msgs;message_runtime;nav_core;nav_msgs;pluginlib;roscpp;sensor_msgs;std_msgs;tf2;tf2_ros;voxel_grid")
