...
if("TRUE" STREQUAL "TRUE")
  set(rotate_recovery_SOURCE_PREFIX /home/boocax/UstarService/src/ustar_move/rotate_recovery)
  set(rotate_recovery_DEVEL_PREFIX /home/boocax/UstarService/devel)
  ...
  set(rotate_recovery_INSTALL_PREFIX /home/boocax/UstarService/install)
...
if(NOT "/home/boocax/UstarService/src/ustar_move/rotate_recovery/include " STREQUAL " ")
  set(rotate_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/home/boocax/UstarService/src/ustar_move/rotate_recovery/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rotate_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/boocax/UstarService/src/ustar_move/rotate_recovery/${idir}'.  ${_report}")
    endif()
...
set(depends "costmap;geometry_msgs;nav_core;pluginlib;roscpp;tf2;tf2_ros")
