...
if("TRUE" STREQUAL "TRUE")
  set(map_server_SOURCE_PREFIX /home/boocax/UstarService/src/map_server)
  set(map_server_DEVEL_PREFIX /home/boocax/UstarService/devel)
  ...
  set(map_server_INSTALL_PREFIX /home/boocax/UstarService/install)
...
if(NOT "/home/boocax/UstarService/src/map_server/include " STREQUAL " ")
  set(map_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/boocax/UstarService/src/map_server/include")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "http://wiki.ros.org/map_server " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'David V. Lu!! <1124782663@qq.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/boocax/UstarService/src/map_server/${idir}'.  ${_report}")
    endif()
