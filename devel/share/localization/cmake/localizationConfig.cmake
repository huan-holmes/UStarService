...
if("TRUE" STREQUAL "TRUE")
  set(localization_SOURCE_PREFIX /home/boocax/UstarService/src/localization)
  set(localization_DEVEL_PREFIX /home/boocax/UstarService/devel)
  ...
  set(localization_INSTALL_PREFIX /home/boocax/UstarService/install)
...
if(NOT "/home/boocax/UstarService/devel/include;/home/boocax/UstarService/src/localization/include " STREQUAL " ")
  set(localization_INCLUDE_DIRS "")
  set(_include_dirs "/home/boocax/UstarService/devel/include;/home/boocax/UstarService/src/localization/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/boocax/UstarService/src/localization/${idir}'.  ${_report}")
    endif()
    _list_append_unique(localization_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "sensor;map;pf")
...
set(localization_EXPORTED_TARGETS "localization_gencfg")
