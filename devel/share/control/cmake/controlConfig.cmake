...
if("TRUE" STREQUAL "TRUE")
  set(control_SOURCE_PREFIX /home/boocax/UstarService/src/control)
  set(control_DEVEL_PREFIX /home/boocax/UstarService/devel)
  set(control_INSTALL_PREFIX "")
  set(control_PREFIX ${control_DEVEL_PREFIX})
else()
  set(control_SOURCE_PREFIX "")
  set(control_DEVEL_PREFIX "")
  set(control_INSTALL_PREFIX /home/boocax/UstarService/install)
...
if(NOT "/home/boocax/UstarService/src/control/include " STREQUAL " ")
  set(control_INCLUDE_DIRS "")
  set(_include_dirs "/home/boocax/UstarService/src/control/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'huan-holmes <11224782663@qq.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/boocax/UstarService/src/control/${idir}'.  ${_report}")
    endif()
