...
#include "gmapping/scanmatcher/motionmodel.h"
...
namespace UstarSlam
{
  ...
  */
   ...
   */
    ...
    typedef std::vector<MatchProcessor::TNode *> TNodeVector;
    typedef std::deque<MatchProcessor::TNode *> TNodeDeque;
  ...
  protected:
    /**Copy constructor*/
    MatchProcessor(const MatchProcessor &gsp);
  ...
  typedef std::multimap<const MatchProcessor::TNode *, MatchProcessor::TNode *> TNodeMultimap;

#include "gmapping/scanmatcher/matchprocessor.hxx"
