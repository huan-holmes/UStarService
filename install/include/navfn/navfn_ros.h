...
namespace navfn {
   ...
   */
  class NavfnROS : public UstarPlanning::BaseGlobalPlanner {
    public:
      /**
       ...
       */
      NavfnROS(std::string name, UstarCostmap::Costmap2DROS* costmap_ros);
       ...
       */
      NavfnROS(std::string name, UstarCostmap::Costmap2D* costmap, std::string global_frame);
       ...
       * @param  global_frame The global frame of the costmap
       */
      void initialize(std::string name, UstarCostmap::Costmap2D* costmap, std::string global_frame);
