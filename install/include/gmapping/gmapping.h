...
namespace UstarSlam
{
  ...
  public:
    UstarGMapping();
    UstarGMapping(ros::NodeHandle &nh, ros::NodeHandle &pnh);
    UstarGMapping(unsigned long int seed, unsigned long int max_duration_buffer);
    ~UstarGMapping();
  ...
  private:
    ...
    UstarSlam::MatchProcessor *gsp_;
    UstarSlam::RangeSensor *gsp_laser_;
    ...
    UstarSlam::OdometrySensor *gsp_odom_;
    ...
    bool getOdomPose(UstarSlam::OrientedPoint &gmap_pose, const ros::Time &t);
    bool initMapper(const sensor_msgs::LaserScan &scan);
    bool addScan(const sensor_msgs::LaserScan &scan, UstarSlam::OrientedPoint &gmap_pose);
