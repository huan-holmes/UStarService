...
inline void MatchProcessor::scanMatch(const double* plainReading){
...
inline void MatchProcessor::normalize(){
...
inline bool MatchProcessor::resample(const double* plainReading, int adaptSize, const RangeReading* reading){
