...
namespace base_local_planner {
  ...
  class TrajectoryPlanner{
    ...
    public:
      ...
      geometry_msgs::Polygon getFootprintPolygon() const { return UstarCostmap::toPolygon(footprint_spec_); }
    ...
    private:
      ...
      const UstarCostmap::Costmap2D& costmap_; ///< @brief Provides access to cost map information
