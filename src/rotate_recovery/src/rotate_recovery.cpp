...
PLUGINLIB_EXPORT_CLASS(rotate_recovery::RotateRecovery, UstarPlanning::RecoveryBehavior)
                                ...
                                UstarCostmap::Costmap2DROS*, UstarCostmap::Costmap2DROS* local_costmap)
{
  if (!initialized_)
  {
    ...
    acc_lim_th_ = UstarPlanning::loadParameterWithDeprecation(blp_nh, "acc_lim_theta", "acc_lim_th", 3.2);
    max_rotational_vel_ = UstarPlanning::loadParameterWithDeprecation(blp_nh, "max_vel_theta", "max_rotational_vel", 1.0);
    min_rotational_vel_ = UstarPlanning::loadParameterWithDeprecation(blp_nh, "min_in_place_vel_theta", "min_in_place_rotational_vel", 0.4);
