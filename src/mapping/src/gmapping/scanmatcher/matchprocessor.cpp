...
namespace UstarSlam
{
  ...
  MatchProcessor::MatchProcessor(const MatchProcessor &gsp)
  ...
  MatchProcessor::MatchProcessor(std::ostream &infoS) : m_infoStream(infoS)
  {
    period_ = 5.0;
    m_obsSigmaGain = 1;
    m_resampleThreshold = 0.5;
  ...
  MatchProcessor *MatchProcessor::clone() const
  {
#ifdef MAP_CONSISTENCY_CHECK
...
#endif
    MatchProcessor *cloned = new MatchProcessor(*this);
  ...
  void MatchProcessor::setMatchingParameters(double urange, double range, double sigma, int kernsize, double lopt, double aopt,
  ...
  void MatchProcessor::setMotionModelParameters(double srr, double srt, double str, double stt)
  {
  ...
  void MatchProcessor::setUpdateDistances(double linear, double angular, double resampleThreshold)
  {
  ...
  MatchProcessor::Particle::Particle(const ScanMatcherMap &m) : map(m), pose(0, 0, 0), weight(0), weightSum(0), gweight(0), previousIndex(0)
  {
    node = 0;
  }
  ...
  void MatchProcessor::init(unsigned int size, double xmin, double ymin, double xmax, double ymax, double delta, OrientedPoint initialPose)
  {
    m_xmin = xmin;
    m_ymin = ymin;
    m_xmax = xmax;
  ...
  void MatchProcessor::processTruePos(const OdometryReading &o)
  {
  ...
  bool MatchProcessor::processScan(const RangeReading &reading, int adaptParticles)
  {
  ...
  std::ofstream &MatchProcessor::outputStream()
  {
    return m_outputStream;
  }

  std::ostream &MatchProcessor::infoStream()
  {
    return m_infoStream;
  }

  int MatchProcessor::getBestParticleIndex() const
  {
    unsigned int bi = 0;
  ...
  void MatchProcessor::onScanmatchUpdate() {}
  void MatchProcessor::onResampleUpdate() {}
  void MatchProcessor::onOdometryUpdate() {}
