...
namespace UstarSlam
{
  ...
  UstarGMapping::UstarGMapping(ros::NodeHandle &nh, ros::NodeHandle &pnh) : map_to_odom_(tf::Transform(tf::createQuaternionFromRPY(0, 0, 0), tf::Point(0, 0, 0))),
  ...
  bool
  UstarGMapping::getOdomPose(UstarSlam::OrientedPoint &gmap_pose, const ros::Time &t)
  {
