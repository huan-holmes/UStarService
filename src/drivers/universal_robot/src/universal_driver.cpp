...
UniversalNode::UniversalNode() {
    ...
    nh.param<float>("robooster_slow_down", kinematic_.slow_down, 75.0);
    nh.param<float>("robooster_wheel_radius", kinematic_.wheel_radius, 0.20);
    nh.param<float>("robooster_encoder_lines", kinematic_.encoder_lines, 1024);
    nh.param<float>("robooster_wheel_gauge", kinematic_.wheel_gauge, 0.75);
    std::cout << "-----------------------------------------------------------------" << std::endl;
