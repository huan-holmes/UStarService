...
#ifndef USTAR_BASE_LOCAL_PLANNER_H
#define USTAR_BASE_LOCAL_PLANNER_H
...
namespace UstarPlanning
{
   ...
   */
   ...
   public:
       ...
       */
      virtual void initialize(std::string name, tf2_ros::Buffer *tf, UstarCostmap::Costmap2DROS *costmap_ros) = 0;
...
#endif // USTAR_BASE_LOCAL_PLANNER_H
