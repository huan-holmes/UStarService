#ifndef USTAR_BASE_GLOBAL_PLANNER_H
#define USTAR_BASE_GLOBAL_PLANNER_H
...
namespace global_planner
{
  ...
  public:
    ...
    /**
       ...
       */
    virtual void initialize(std::string name, UstarCostmap::Costmap2DROS *costmap_ros) = 0;
...
#endif // Ustar_BASE_GLOBAL_PLANNER_H