...
PLUGINLIB_EXPORT_CLASS(navfn::NavfnROS, UstarPlanning::BaseGlobalPlanner)
...
namespace navfn {
  ...
  NavfnROS::NavfnROS(std::string name, UstarCostmap::Costmap2DROS* costmap_ros)
    : costmap_(NULL),  planner_(), initialized_(false), allow_unknown_(true) {
      //initialize the planner
      initialize(name, costmap_ros);
  }

  NavfnROS::NavfnROS(std::string name, UstarCostmap::Costmap2D* costmap, std::string global_frame)
    : costmap_(NULL),  planner_(), initialized_(false), allow_unknown_(true) {
      //initialize the planner
      initialize(name, costmap, global_frame);
  }

  void NavfnROS::initialize(std::string name, UstarCostmap::Costmap2D* costmap, std::string global_frame){
    if(!initialized_){
      costmap_ = costmap;
  ...
  void NavfnROS::initialize(std::string name, UstarCostmap::Costmap2DROS* costmap_ros){
