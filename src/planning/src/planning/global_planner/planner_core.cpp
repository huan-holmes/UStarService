...
#include <planning/global_planner/planner_core.h>
#include <pluginlib/class_list_macros.h>
#include <costmap/utils/cost_values.h>
#include <costmap/costmap_2d/costmap_2d.h>

#include <planning/global_planner/dijkstra.h>
#include <planning/global_planner/astar.h>
#include <planning/global_planner/grid_path.h>
#include <planning/global_planner/gradient_path.h>
#include <planning/global_planner/quadratic_calculator.h>
...
GlobalPlanner::GlobalPlanner(std::string name, UstarCostmap::Costmap2D* costmap, std::string frame_id) :
        costmap_(NULL), initialized_(false), allow_unknown_(true) {
...
void GlobalPlanner::initialize(std::string name, UstarCostmap::Costmap2DROS* costmap_ros) {
    initialize(name, costmap_ros->getCostmap(), costmap_ros->getGlobalFrameID());
}

void GlobalPlanner::initialize(std::string name, UstarCostmap::Costmap2D* costmap, std::string frame_id) {
    if (!initialized_) {
...
void GlobalPlanner::clearRobotCell(const geometry_msgs::PoseStamped& global_pose, unsigned int mx, unsigned int my) {
    ...
    costmap_->setCost(mx, my, UstarCostmap::FREE_SPACE);
}
...
bool GlobalPlanner::makePlan(const geometry_msgs::PoseStamped& start, const geometry_msgs::PoseStamped& goal,
    ...
    if(outline_map_)
        outlineMap(costmap_->getCharMap(), nx, ny, UstarCostmap::LETHAL_OBSTACLE);
