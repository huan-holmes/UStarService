...
#include <planning/global_planner/potential_calculator.h>
#include <planning/global_planner/expander.h>
#include <planning/global_planner/traceback.h>
#include "planning/global_planner/orientation_filter.h"
#include "planning/GlobalPlannerConfig.h"
...
class GlobalPlanner : public UstarPlanning::BaseGlobalPlanner {
    public:
         ...
         */
        GlobalPlanner(std::string name, UstarCostmap::Costmap2D* costmap, std::string frame_id);
         ...
         */
        void initialize(std::string name, UstarCostmap::Costmap2DROS* costmap_ros);

        void initialize(std::string name, UstarCostmap::Costmap2D* costmap, std::string frame_id);
