...
#include <vector>
#include <iostream>
#include <planning/local_planner/trajectory_inc.h>
#include <ros/console.h>
#include <ros/ros.h>

#include <planning/local_planner/map_cell.h>
  ...
  class MapGrid{
    public:
      ...
      inline bool updatePathCell(MapCell* current_cell, MapCell* check_cell,
          const UstarCostmap::Costmap2D& costmap);
       ...
       */
      void computeTargetDistance(std::queue<MapCell*>& dist_queue, const UstarCostmap::Costmap2D& costmap);
       ...
       */
      void computeGoalDistance(std::queue<MapCell*>& dist_queue, const UstarCostmap::Costmap2D& costmap);

      /**
       * @brief Update what cells are considered path based on the global plan 
       */
      void setTargetCells(const UstarCostmap::Costmap2D& costmap, const std::vector<geometry_msgs::PoseStamped>& global_plan);

      /**
       * @brief Update what cell is considered the next local goal
       */
      void setLocalGoal(const UstarCostmap::Costmap2D& costmap,
