...
#include "planning/local_planner/world_model.h"
#include "planning/local_planner/point_grid.h"
#include "planning/local_planner/costmap_model.h"
#include "planning/local_planner/voxel_grid_model.h"
#include "planning/local_planner/trajectory_planner.h"
#include "planning/local_planner/map_grid_visualizer.h"

#include "planning/local_planner/planar_laser_scan.h"
...
#include "planning/BaseLocalPlannerConfig.h"

#include "planning/local_planner/odometry_helper_ros.h"
...
namespace base_local_planner {
  ...
  class TrajectoryPlannerROS : public nav_core::BaseLocalPlanner {
    ...
    private:
      ...
      UstarCostmap::Costmap2DROS* costmap_ros_; ///< @brief The ROS wrapper for the costmap the controller will use
      UstarCostmap::Costmap2D* costmap_; ///< @brief The costmap the controller will use
