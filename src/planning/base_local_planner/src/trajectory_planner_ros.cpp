...
PLUGINLIB_EXPORT_CLASS(base_local_planner::TrajectoryPlannerROS, UstarPlanning::BaseLocalPlanner)
...
namespace base_local_planner {
  ...
  TrajectoryPlannerROS::TrajectoryPlannerROS(std::string name, tf2_ros::Buffer* tf, UstarCostmap::Costmap2DROS* costmap_ros) :
      world_model_(NULL), tc_(NULL), costmap_ros_(NULL), tf_(NULL), setup_(false), initialized_(false), odom_helper_("odom") {
  ...
  void TrajectoryPlannerROS::initialize(
    ...
    if (! isInitialized()) {
      ...
      path_distance_bias = UstarPlanning::loadParameterWithDeprecation(private_nh,
                                                                  "path_distance_bias",
                                                                  "pdist_scale",
                                                                  0.6);
      goal_distance_bias = UstarPlanning::loadParameterWithDeprecation(private_nh,
                                                                  "goal_distance_bias",
                                                                  "gdist_scale",
                                                                  0.6);
      ...
      min_in_place_vel_th_ = UstarPlanning::loadParameterWithDeprecation(private_nh,
