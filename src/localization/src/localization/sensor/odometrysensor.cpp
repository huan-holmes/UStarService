...
namespace UstarLocalization
{
  ...
  ////////////////////////////////////////////////////////////////////////////////
  // Default constructor
  OdometrySensor::OdometrySensor() : Sensor()
  {
    this->time = 0.0;
  }

  void
  OdometrySensor::SetModelDiff(double alpha1,
                               double alpha2,
                               double alpha3,
                               double alpha4)
  {
  ...
  void
  OdometrySensor::SetModelOmni(double alpha1,
                               double alpha2,
                               double alpha3,
                               double alpha4,
                               double alpha5)
  ...
  void
  OdometrySensor::SetModel(odom_model_t type,
                           double alpha1,
                           double alpha2,
                           double alpha3,
                           double alpha4,
  ...
  bool OdometrySensor::UpdateAction(pf_t *pf, SensorData *data)
  {
    OdometrySensorData *ndata;
    ndata = (OdometrySensorData *)data;
