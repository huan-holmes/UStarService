...
V_Cell g_cells;
void voxelCallback(const ros::Publisher &pub, const costmap::VoxelGridConstPtr &grid)
{
  if (grid->data.empty())
  {
...
int main(int argc, char **argv)
{
  ...
  ros::Subscriber sub = n.subscribe<costmap::VoxelGrid>("voxel_grid", 1, boost::bind(voxelCallback, pub, _1));
