#include "costmap/layers/static_layer.h"
#include "costmap/utils/costmap_math.h"
#include <pluginlib/class_list_macros.h>
#include <tf2/convert.h>
#include <tf2_geometry_msgs/tf2_geometry_msgs.h>

PLUGINLIB_EXPORT_CLASS(UstarCostmap::StaticLayer, UstarCostmap::Layer)
...
namespace UstarCostmap
{
  ...
  void StaticLayer::onInitialize()
  {
    ...
    dsrv_ = new dynamic_reconfigure::Server<UstarCostmap::GenericPluginConfig>(nh);
    dynamic_reconfigure::Server<UstarCostmap::GenericPluginConfig>::CallbackType cb = boost::bind(
        &StaticLayer::reconfigureCB, this, _1, _2);
    dsrv_->setCallback(cb);
  }

  void StaticLayer::reconfigureCB(UstarCostmap::GenericPluginConfig &config, uint32_t level)
  {
  ...
  void StaticLayer::updateCosts(UstarCostmap::Costmap2D &master_grid, int min_i, int min_j, int max_i, int max_j)
  {
    if (!map_received_)
      return;
