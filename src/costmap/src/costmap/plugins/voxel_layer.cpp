#include "costmap/layers/voxel_layer.h"
#include <pluginlib/class_list_macros.h>
#include <sensor_msgs/point_cloud2_iterator.h>

#define VOXEL_BITS 16
PLUGINLIB_EXPORT_CLASS(UstarCostmap::VoxelLayer, UstarCostmap::Layer)
...
namespace UstarCostmap
{
  ...
  void VoxelLayer::onInitialize()
  {
    ...
    if (publish_voxel_)
      voxel_pub_ = private_nh.advertise<costmap::VoxelGrid>("voxel_grid", 1);
  ...
  {
    voxel_dsrv_ = new dynamic_reconfigure::Server<UstarCostmap::VoxelPluginConfig>(nh);
    dynamic_reconfigure::Server<UstarCostmap::VoxelPluginConfig>::CallbackType cb = boost::bind(
  ...
  void VoxelLayer::reconfigureCB(UstarCostmap::VoxelPluginConfig &config, uint32_t level)
  {
