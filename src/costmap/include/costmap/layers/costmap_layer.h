...
namespace UstarCostmap
{
  ...
  class CostmapLayer : public Layer, public Costmap2D
  {
    ...
    protected:
       ...
       */
      void updateWithTrueOverwrite(UstarCostmap::Costmap2D &master_grid, int min_i, int min_j, int max_i, int max_j);
       ...
       */
      void updateWithOverwrite(UstarCostmap::Costmap2D &master_grid, int min_i, int min_j, int max_i, int max_j);
       ...
       */
      void updateWithMax(UstarCostmap::Costmap2D &master_grid, int min_i, int min_j, int max_i, int max_j);
       ...
       */
      void updateWithAddition(UstarCostmap::Costmap2D &master_grid, int min_i, int min_j, int max_i, int max_j);
